...
export const SIDEBAR_NAV_ENTRIES: SidebarNavEntry[] = [
  { type: 'link', href: '/dashboard', label: 'Dashboard', icon: LayoutDashboard },
  {
    ...
    children: [
      { href: '/stock/materials', label: 'Materials', perm: 'material.view' },
      { href: '/stock/goods-receipt', label: 'Goods Receipt', perm: 'transaction.stock_in' },
      { href: '/stock/dispatch', label: 'Dispatch', perm: 'transaction.stock_out' },
      { href: '/stock/daily-quantity-log', label: 'Production Log', perm: P.STOCK_PRODUCTION_LOG_VIEW },
      { href: '/stock/job-budget', label: 'Job Budget', perm: P.STOCK_JOB_BUDGET_VIEW },
    ],
  },
  { type: 'link', href: '/suppliers', label: 'Suppliers', icon: Building2, perm: 'supplier.view' },
  {
    type: 'group',
    id: 'customers',
    label: 'Customers',
  ...
  { type: 'link', href: '/settings', label: 'Settings', icon: Settings, perm: 'settings.manage' },
];
