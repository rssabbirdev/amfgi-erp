...
- **getItemTypeLabel()** (5 connections) — `lib/utils/itemTypeFields.ts`
...
- **TemplateMetaBadge()** (3 connections) — `app/(app)/settings/page.tsx`
...
- [[Components and Lib]] (11 shared connections)
