...
- **isEmployeeSelfServiceUser()** (13 connections) — `lib/auth/selfService.ts`
- **Header.tsx** (9 connections) — `components/layout/Header.tsx`
- **selfService.ts** (9 connections) — `lib/auth/selfService.ts`
- **isEmployeeSelfServiceUser()** (6 connections) — `lib/auth/selfService.ts`
...
- **isEmployeeSelfServiceAccount()** (3 connections) — `lib/auth/selfService.ts`
- **Sidebar()** (3 connections) — `components/layout/Sidebar.tsx`
- **HoverTooltip()** (2 connections) — `components/ui/HoverTooltip.tsx`
- **handlePointerDown()** (2 connections) — `components/layout/Header.tsx`
- **handleKeyDown()** (2 connections) — `components/layout/Header.tsx`
- **Header.tsx** (2 connections) — `components/layout/Header.tsx`
- **HoverTooltip.tsx** (2 connections) — `components/ui/HoverTooltip.tsx`
- **proxy.ts** (1 connections) — `proxy.ts`
- **page.tsx** (1 connections) — `app/page.tsx`
- **page.tsx** (1 connections) — `app/unauthorized/page.tsx`
- **SelfServiceCandidate** (1 connections) — `lib/auth/selfService.ts`
- **proxy.ts** (1 connections) — `proxy.ts`
- **page.tsx** (1 connections) — `app/page.tsx`
- **page.tsx** (1 connections) — `app/unauthorized/page.tsx`
