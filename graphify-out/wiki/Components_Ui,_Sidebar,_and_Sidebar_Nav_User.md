...
- **NavDef** (1 connections) — `components/layout/Sidebar.tsx`
- **NAV_ITEMS** (1 connections) — `components/layout/Sidebar.tsx`
- **SELF_SERVICE_ITEMS** (1 connections) — `components/layout/Sidebar.tsx`
- **NavItem** (1 connections) — `components/layout/Sidebar.tsx`
- **SidebarProps** (1 connections) — `components/layout/Sidebar.tsx`
