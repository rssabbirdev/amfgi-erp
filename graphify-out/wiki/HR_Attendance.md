...
- **page.tsx** (39 connections) — `app/(app)/hr/attendance/create/page.tsx`
...
- **buildDraftFromExistingRow()** (3 connections) — `app/(app)/hr/attendance/create/page.tsx`
...
- **calculateWorkedMinutes()** (2 connections) — `app/(app)/hr/attendance/create/page.tsx`
- **buildDraftFromDefaults()** (2 connections) — `app/(app)/hr/attendance/create/page.tsx`
- **AttendanceGridEmployee** (2 connections) — `components/hr/AttendanceEntryGrid.tsx`
- **AttendanceGridDraftRow** (2 connections) — `components/hr/AttendanceEntryGrid.tsx`
...
- [[Reports, Components, and Admin]] (6 shared connections)
- [[Components, HR, and Attendance Entry Grid]] (3 shared connections)
- [[Stock, Lib, and Components]] (3 shared connections)
